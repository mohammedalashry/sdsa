...
// authRouter.post("/change-password/", validate(changePasswordValidation), changePassword);
...
// authRouter.post("/login-with-facebook/", validate(facebookLoginValidation), facebookLogin);

// POST /api/auth/login-with-google/ - Login with Google
// authRouter.post("/login-with-google/", validate(googleLoginValidation), googleLogin);
...
// authRouter.post("/set-new-password/", validate(setNewPasswordValidation), setNewPassword);

// POST /api/auth/validate-otp/ - Validate OTP
// authRouter.post("/validate-otp/", validate(validateOtpValidation), validateOtp);

// POST /api/auth/x-get-auth-url/ - Get X auth URL
// authRouter.post("/x-get-auth-url/", validate(getAuthUrlValidation), getAuthUrl);
